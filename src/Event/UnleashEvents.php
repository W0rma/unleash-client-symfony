...
final readonly class UnleashEvents
{
     ...
     */
    public const string CONTEXT_VALUE_NOT_FOUND = 'unleash.client.event.context_not_found';

    /**
     * @Event("Unleash\Client\Bundle\Event\BeforeExceptionThrownForAttributeEvent")
     */
    public const string BEFORE_EXCEPTION_THROWN_FOR_ATTRIBUTE = 'unleash.client.event.before_exception_attribute';
}
